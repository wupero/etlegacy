...
cvarTable_t gameCvarTable[] =
{
	...
	// multiplayer stuffs
	{ &g_redlimbotime,                    "g_redlimbotime",                    "1000",                      CVAR_SERVERINFO | CVAR_ROM,                      0, qfalse, qfalse }, // timerun mod: hardcoded 1s — read-only so mapscripts/config/Lua cannot change it
	{ &g_bluelimbotime,                   "g_bluelimbotime",                   "1000",                      CVAR_SERVERINFO | CVAR_ROM,                      0, qfalse, qfalse }, // timerun mod: hardcoded 1s — read-only so mapscripts/config/Lua cannot change it
	...
	{ &g_apiKey,                          "g_apiKey",                          "",                           0,                                               0, qfalse, qfalse },
