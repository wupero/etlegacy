...
modTable_t modTable[MOD_NUM_MODS] =
{
	...
	{ MOD_TIMERUN_MISSING_CP,                WP_NONE,                 qfalse,    qfalse,     WEAPON_CLASS_FOR_MOD_NO,        qtrue,       "was killed by",             "",                               "Missing %d checkpoint(s) - get them all to finish!", NULL,                                     "MOD_TIMERUN_MISSING_CP",                  SK_NUM_SKILLS,                            0.f,             0.f,             {0.f, 0.f, 0.f, 0.f}, qfalse,      "",                    2,            WS_MAX             },
};
